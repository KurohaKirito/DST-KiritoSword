...
2. 下载本仓库, 解压后放置到 `Steam\steamapps\common\Don't Starve Together\mods` 路径下, 文件夹随意的英文名即可, 推荐 `KiritoSword`, 之后重启游戏即可!

3. [**重要**] `2021-07-20 14:29:19` 测试可正常运行!
...
- <kbd>蚁狮 BOSS</kbd> 必定掉落 1 个水晶石英铸块
...
- 新增掉落: 10% 掉落 <kbd>逐暗者</kbd>

- 新增掉落: 10% 掉落 <kbd>蓝蔷薇之剑</kbd>

- 新增掉落: 10% 掉落 <kbd>夜空之剑</kbd>

- 新增掉落: 10% 掉落 <kbd>阐释者</kbd>
