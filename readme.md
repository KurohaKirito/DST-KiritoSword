...
此版本仅作为自用, 上传到创意工坊仅为了联机方便.

此仓库仅对原 MOD 进行了汉化, 修改了部分属性, 添加了星爆气流斩特性.
...
3. [**重要**] 虽说文件夹命名可以随意, 但是也必须满足一个要求:【主机和客机的文件夹命名必须一致，否则会提示缺失 MOD，无法进入游戏】

4. [**重要**] `2022年11月11日` 测试可正常运行!

5. `2022年11月11日` 制作栏适配更新
...
蓝蔷薇之剑是尤吉欧的爱剑, 在尽头山脉中获得, 制作夜空之剑的恶魔之树就是这把剑砍倒的.
...
- `武器完全支配术`: `蔷薇绽放`, 有 35% 的几率发动, 对周围 5 米的所有敌对生物造成 50% 的冰冻效果, 并附带 100 点伤害.
...
- 制作: <kbd>冰块</kbd> X 25, <kbd>蓝宝石</kbd> X 1

- 掉落: <kbd>蚁狮 BOSS</kbd> 必定掉落 1 个水晶石英铸块
...
- 制作: <kbd>阐释宝石</kbd> X 2, <kbd>噩梦燃料</kbd> X 8

# 阐释宝石

![阐释宝石](readme/7-elucidatorgem.png)

- 制作: <kbd>红宝石</kbd> X 1, <kbd>绿宝石</kbd> X 1

- 掉落: <kbd>蚁狮 BOSS</kbd> 必定掉落 2 阐释宝石
...
新增掉落: 必定掉落 <kbd>阐释宝石</kbd> X 2, <kbd>水晶石英铸块</kbd> X 1

# 克劳斯

![克劳斯](readme/Klaus.webp)

- 新增掉落: 40% 掉落 <kbd>蓝蔷薇之剑</kbd>

- 新增掉落: 40% 掉落 <kbd>夜空之剑</kbd>

- 新增掉落: 30% 掉落 <kbd>逐暗者</kbd>

- 新增掉落: 30% 掉落 <kbd>阐释者</kbd>
